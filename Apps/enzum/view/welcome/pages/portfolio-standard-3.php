                            ...
                            <div class="portfolio standard three">
                                <div id="isotope-container" class="portfolio-container">
                                    <div class="item" id="construction">
                                        <div class="border">
                                           <img src="<?=TEMPLATE?>images/portfolio-dancing-fashion.jpg" class="scale-with-grid" />
                                           <a href="<?=TEMPLATE?>images/untouched/dancing-fashion.jpg" class="zoom prettyPhoto"></a>
                                        </div>
                                    ...
                                    <div class="item" id="construction">
                                        <div class="border">
                                            <img src="<?=TEMPLATE?>images/portfolio-woman-streaming.jpg" class="scale-with-grid" />
                                        	<a href="<?=TEMPLATE?>images/untouched/woman-streaming.jpg" class="zoom prettyPhoto"></a>
                                        </div>
                                        <h5><a href="#">Portfolio Title Goes Here</a></h5>
                                        <p>Construction</p>
                                        <div class="shadow"></div>
                                    ...
                                    <div class="item" id="revelation">
                                        <div class="border"><img src="<?=TEMPLATE?>images/portfolio-target.jpg" class="scale-with-grid" />
                                    ...
                                    <div class="item" id="revelation">
                                        <div class="border">
                                            <img src="<?=TEMPLATE?>images/portfolio-business-model.jpg" class="scale-with-grid" />
                                    ...
                                    <div class="item" id="construction">
                                        <div class="border">
                                        	<img src="<?=TEMPLATE?>images/portfolio-glam.jpg" class="scale-with-grid" />
                                            <a href="<?=TEMPLATE?>images/untouched/glam.jpg" class="zoom prettyPhoto"></a>
                                        </div>
                                        <h5><a href="#">Portfolio Title Goes Here</a></h5>
                                        <p>Construction</p>
                                        <div class="shadow"></div>
                                    ...
                                    <div class="item" id="revelation">
                                        <div class="border">
                                        	<img src="<?=TEMPLATE?>images/portfolio-woman-laptop.jpg" class="scale-with-grid" />
                                    ...
                                    <div class="item" id="revelation">
                                        <div class="border">
                                        	<img src="<?=TEMPLATE?>images/portfolio-woman-executives.jpg" class="scale-with-grid" />
