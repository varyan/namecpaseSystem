                ...
                <div class="content">
                    ...
                    <div class="container">
                        <div class="sixteen columns">
                            ...
                            <!-- Isotope Begins -->
                            <div class="portfolio standard two">
                                <div id="isotope-container" class="portfolio-container">
                                    <div class="item" id="construction">
                                        <div class="border"><img src="<?=TEMPLATE?>images/portfolio-large-cows.jpg" class="scale-with-grid" />
                                       		<a href="<?=TEMPLATE?>images/untouched/agents.jpg" class="zoom prettyPhoto"></a>
                                        </div>
                                    ...
                                    <div class="item" id="construction">
                                        <div class="border">
                                            <img src="<?=TEMPLATE?>images/portfolio-large-cows.jpg" class="scale-with-grid" />
                                        	<a href="<?=TEMPLATE?>images/untouched/agents.jpg" class="zoom prettyPhoto"></a>
                                        </div>
                                        <h5><a href="#">Portfolio Title Goes Here</a></h5>
                                        <p>Construction</p>
                                    ...
                                    <div class="item" id="revelation">
                                        <div class="border"><img src="<?=TEMPLATE?>images/portfolio-large-mnt.jpg" class="scale-with-grid" />
