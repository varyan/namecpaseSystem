					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="<?=TEMPLATE?>images/icon-vs.png" alt="VarYan`s System"></a>
							</div>

							<!-- name-and-slogan -->
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="#banner">VarYan`s System</a></div>
								<div class="site-slogan">Free Model View Controller <a target="_blank" href="http://htmlcoder.me">Framework</a></div>
							</div>
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-right">
												<?php foreach($menus as $menu) : ?>
													<li <?=($menu->linkURL == '#banner') ? 'class="active"' : ''?>><a href="<?=$menu->linkURL?>"><?=$menu->title?></a></li>
												<?php endforeach; ?>
											</ul>
										</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<h2 class="text-center">VarYan`s System | <span>MVC Framework</span></h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<img src="<?=TEMPLATE?>images/section-image-1.png" alt="">
								<div class="space"></div>
							</div>
							<div class="col-md-6">
					...
					<div class="col-md-12">
						...
						<div class="isotope-container row grid-space-20">
							...
							<div class="col-sm-6 col-md-3 isotope-item site-building">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?=TEMPLATE?>images/portfolio-7.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?=TEMPLATE?>images/portfolio-8.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?=TEMPLATE?>images/portfolio-9.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?=TEMPLATE?>images/portfolio-11.jpg" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="<?=TEMPLATE?>images/portfolio-12.jpg" alt="">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?=TEMPLATE?>images/testimonial-1.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?=TEMPLATE?>images/testimonial-2.png" alt="">
							</div>
							<div class="media-body">
					...
					<div class="col-md-4">
						<div class="media testimonial">
							<div class="media-left">
								<img src="<?=TEMPLATE?>images/testimonial-3.png" alt="">
							</div>
							<div class="media-body">
						...
						<div class="row">
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-1.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-2.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-3.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-4.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-5.png" alt="client">
								</div>
							</div>
							<div class="col-xs-2">
								<div class="list-horizontal-item">
									<img src="<?=TEMPLATE?>images/client-6.png" alt="client">
								</div>
							</div>
						</div>
					</div>
